...
export const ScalesIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <line x1="12" y1="3" x2="12" y2="21" />
    <path d="M5 6h14M3 12l2-6 2 6a2 2 0 01-4 0zM15 12l2-6 2 6a2 2 0 01-4 0z" />
...
export const PhoneIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.8a19.79 19.79 0 01-3.07-8.67A2 2 0 012 0h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 14.92z" transform="translate(1 1)" />
  </svg>
);
...
export const QuoteIcon: React.FC<IconProps> = ({ size = 40, color = 'currentColor', className }) => (
  <svg width={size} height={size} viewBox="0 0 40 40" fill={color} className={className}>
    <path d="M12 8C7.6 8 4 11.6 4 16v16h16V16H8c0-2.2 1.8-4 4-4h2V8h-2zm20 0c-4.4 0-8 3.6-8 8v16h16V16h-12c0-2.2 1.8-4 4-4h2V8h-2z" opacity="0.3"/>
  </svg>
);
